...
extern XORG_EXPORT I2CBusPtr xf86CreateI2CBusRec(void);

#define DestroyI2CBusRec	xf86DestroyI2CBusRec
extern XORG_EXPORT void xf86DestroyI2CBusRec(I2CBusPtr pI2CBus, Bool unalloc,
                                           Bool devs_too);
#define I2CBusInit		xf86I2CBusInit
extern XORG_EXPORT Bool xf86I2CBusInit(I2CBusPtr pI2CBus);

extern XORG_EXPORT I2CBusPtr xf86I2CFindBus(int scrnIndex, char *name);
extern XORG_EXPORT int xf86I2CGetScreenBuses(int scrnIndex,
                                           I2CBusPtr ** pppI2CBus);
...
extern XORG_EXPORT I2CDevPtr xf86CreateI2CDevRec(void);
extern XORG_EXPORT void xf86DestroyI2CDevRec(I2CDevPtr pI2CDev, Bool unalloc);

#define I2CDevInit		xf86I2CDevInit
extern XORG_EXPORT Bool xf86I2CDevInit(I2CDevPtr pI2CDev);
extern XORG_EXPORT I2CDevPtr xf86I2CFindDev(I2CBusPtr, I2CSlaveAddr);

/* See descriptions of these functions in xf86i2c.c */

#define I2CProbeAddress		xf86I2CProbeAddress
extern XORG_EXPORT Bool xf86I2CProbeAddress(I2CBusPtr pI2CBus, I2CSlaveAddr);

#define		I2C_WriteRead xf86I2CWriteRead
extern XORG_EXPORT Bool xf86I2CWriteRead(I2CDevPtr d, I2CByte * WriteBuffer,
                                       int nWrite, I2CByte * ReadBuffer,
                                       int nRead);
#define 	xf86I2CRead(d, rb, nr) xf86I2CWriteRead(d, NULL, 0, rb, nr)

extern XORG_EXPORT Bool xf86I2CReadStatus(I2CDevPtr d, I2CByte * pbyte);
extern XORG_EXPORT Bool xf86I2CReadByte(I2CDevPtr d, I2CByte subaddr,
                                      I2CByte * pbyte);
extern XORG_EXPORT Bool xf86I2CReadBytes(I2CDevPtr d, I2CByte subaddr,
                                       I2CByte * pbyte, int n);
extern XORG_EXPORT Bool xf86I2CReadWord(I2CDevPtr d, I2CByte subaddr,
                                      unsigned short *pword);
#define 	xf86I2CWrite(d, wb, nw) xf86I2CWriteRead(d, wb, nw, NULL, 0)
extern XORG_EXPORT Bool xf86I2CWriteByte(I2CDevPtr d, I2CByte subaddr,
                                       I2CByte byte);
extern XORG_EXPORT Bool xf86I2CWriteBytes(I2CDevPtr d, I2CByte subaddr,
                                        I2CByte * WriteBuffer, int nWrite);
extern XORG_EXPORT Bool xf86I2CWriteWord(I2CDevPtr d, I2CByte subaddr,
                                       unsigned short word);
extern XORG_EXPORT Bool xf86I2CWriteVec(I2CDevPtr d, I2CByte * vec, int nValues);
